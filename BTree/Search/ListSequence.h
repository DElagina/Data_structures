...
{
public:
	ListSequence<TElement>();
	ListSequence<TElement>(TElement& element);
	~ListSequence<TElement>();
	...
	virtual ListSequence<TElement>* GetSubsequence(int start, int end);
	virtual void Show();
...
private:
	TElement data;
	ListSequence<TElement>* next = nullptr;
};
