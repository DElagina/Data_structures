...
public:
	Sort();
	~Sort();
	void QuickSort(Sequence<TElement>* seq, int start, int end, int up);
	void EasyChoice(Sequence<TElement>* seq, int up);
	//int Visit(Tree<TElement>* ptr, Sequence<TElement>* seq, int up, int i);
	void TreeVisit(BinaryTree<TElement>* root, Sequence<TElement>* seq, int up);
	void TreeChoice(Sequence<TElement>* seq, int up);
};
